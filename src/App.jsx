...
function AppContent() {
  ...
  return (
    <div
      className={`min-h-screen bg-transparent selection:bg-emerald-500 selection:text-white transition-all duration-300 ease-out ${
        sidebarCollapsed ? "lg:ml-0" : "lg:ml-[230px]"
      }`}
