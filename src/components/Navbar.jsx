...
export default function Navbar({ setPage, currentPage = "home", cartCount, pageBadge = {} }) {
  ...
  return (
    <>
      ...
      ═══════════════════════════════════════════════ */}
      <aside className={`hidden lg:flex fixed top-0 left-0 h-screen z-50 w-[220px] flex-col border-r transition-colors duration-300 ${
        isDark
        ...
        {/* Logo */}
        <div
          className={`flex items-center gap-2.5 px-4 h-14 cursor-pointer group shrink-0 border-b ${
            isDark ? "border-white/[0.08]" : "border-stone-200"
          }`}
          onClick={() => go("home")}
        >
          <EducaLogo size={28} />
          <span className={`text-[11px] font-black uppercase tracking-[0.18em] whitespace-nowrap leading-none transition-colors ${
          ...
          {loggedIn ? (
            <>
              ...
              <button
                ...
                className={`w-full flex items-center gap-2.5 p-2 rounded-xl transition-all cursor-pointer border ${
              ...
              <button
                onClick={logout}
                className="w-full py-2 rounded-xl bg-red-500/10 hover:bg-red-500/20 text-red-500 font-black text-[10px] transition-colors cursor-pointer uppercase border border-red-500/20"
              >
                SIGN OUT
              </button>
            </>
            ...
            <button
              onClick={() => go("login")}
              className={`w-full py-2.5 rounded-xl font-bold text-xs uppercase tracking-widest transition-all cursor-pointer ${
